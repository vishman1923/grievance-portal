...
function App() {
  ...
  setLoginError("");
  try {
    const res = await fetch("https://grievance-portal-production-aff9.up.railway.app/api/student/login", {
      method: "POST",
  ...
  const handleAdminLogin = async () => {
    const res = await fetch("https://grievance-portal-production-aff9.up.railway.app/api/admin/loginhttps://grievance-portal-production-aff9.up.railway.app", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleRegister = async () => {
    const res = await fetch("https://grievance-portal-production-aff9.up.railway.app/api/student/register", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  setLoading(true);
  try {
    const res = await fetch("https://grievance-portal-production-aff9.up.railway.app/api/grievances", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const resolveGrievance = async (id) => {
    await fetch(`https://grievance-portal-production-aff9.up.railway.app/api/grievances/${id}/resolve`, { method: "PUT" });
    fetchGrievances();
